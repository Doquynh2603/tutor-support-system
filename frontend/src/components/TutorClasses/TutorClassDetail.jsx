...
const TutorClassDetail = ({ classId, onBack }) => {
  ...
  console.log('chi tiết lớp học', classDetail);
  ...
  // Nếu đang xem thông tin học viên
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="font-semibold">{classDetail.subject_desc || 'Không có'}</p>
            </div>

            <div>
              <label className="text-sm text-muted-foreground">Cấp độ giáo dục</label>
              <p className="font-semibold">Lớp {classDetail.educationLevel}</p>
            </div>
      ...
      <Card>
        ...
        <CardContent>
          {classDetail && classDetail.schedules && classDetail.schedules.length > 0 ? (
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            <span className="font-semibold">{formatTime(schedule.start_time)}</span>
                            {' - '}
                            <span className="font-semibold">{formatTime(schedule.end_time)}</span>
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
